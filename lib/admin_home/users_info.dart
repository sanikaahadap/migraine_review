    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSectionTitle('Headache-Occurence Diary Details'),
          _buildSectionSubtitle('(Tap to view details)'),
          _buildDiaryYes(user.uid),

          _buildSectionTitle('No-Headache Diary Details'),
          _buildSectionSubtitle('(Tap to view details)'),
          _buildDiaryNo(user.uid),
        ],
      ),
    );
  }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                leading:
                const Icon(Icons.sticky_note_2_outlined, color: Colors.green),
                title: Text(formattedDate),
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
